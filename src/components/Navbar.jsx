...
const Navbar = () => {
  ...
  const refs = useRef()
  useClickOutside(refs,()=>{setIsOpen(!isOpen)})
  ...
  return (
    <div className="bg-[#0b0e0a] top-0 fixed z-20  text-[#fff] h-[80px] w-full flex justify-between items-center px-4 ">
      ...
      <ul className="md:flex hidden">
        <li>
          <Link
            to="home" spy={true} smooth={true}  duration={500}  className="cursor-pointer active:text-[#86EAF8] hover:text-[#86EAF8] duration-100"
          >
            Home
          </Link>
        </li>
      ...
      {/* Hamburger */}
      <div  onClick={()=>setIsOpen(!isOpen)} className="md:hidden z-10 cursor-pointer">
      ...
      >
        <li className="pb-8">
          <Link onClick={handleClick} to="home" spy={true} smooth={true}  duration={500} className="active:text-[#86EAF8] duration-100 cursor-pointer">
            Home
          </Link>
        </li>
        <li className="pb-8">
          <Link onClick={handleClick} to="about" spy={true} smooth={true}  duration={500} className="active:text-[#86EAF8] duration-100 cursor-pointer">
            About
          </Link>
        </li>
        <li className="pb-8">
